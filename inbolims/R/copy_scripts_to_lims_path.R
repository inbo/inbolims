...
#'
#'De bestanden worden vanuit het inbolims pakket gekopieerd naar het gekozen pad. De bestaande bestanden in dit pad, worden verplaatst naar een backup folder (met datumaanduiding) in het pad
#'
...
copy_scripts_to_lims_path <- function(path){
  ...
  packagepath <- system.file("lims_scripts", package = "inbolims")
